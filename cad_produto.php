        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <input id="action" type="hidden" name="action" value="inc">
                    <input id="get_sku" type="hidden" name="get_sku" value="0">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="sku" type="text" onkeypress="$(this).mask('#', {reverse: true});" class="form-control" name="sku" required autocomplete="sku" autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="preco" type="text" class="form-control" name="preco" onkeypress="$(this).mask('#,00', {reverse: true});" required autocomplete="preco" autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="quantidade" type="text" class="form-control" name="quantidade" onkeypress="$(this).mask('#', {reverse: true});" required autocomplete="quantidade" autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-md-6">
                              <textarea id="descricao" class="form-control" name="descricao" rows="4" required autocomplete="descricao" autofocus></textarea>
                           </div>
                        </div>
